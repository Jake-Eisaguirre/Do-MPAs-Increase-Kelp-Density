...
In this study, I ask the question; Do MPAs increase Kelp densities and what invertebrate species aid or inhibit Kelp densities? I also take a simplistic approach and address the question; At what point do MPAs and reference sites Kelp Densities significantly differ since implementation of the MPAs?
...
A similar trend occurred for the reference sites. A significant difference in kelp densities since the implementation of MPAs occured 12, 14-17 (p=0.001, \<0.001, \<0.001, 0.002, \<0.001) years after implementation or 2014, 2016, 2017-2019.
